...
input_channels = 3
N_classes = 2
model = UNet3D_Born_etal(pretrained=False, input_channels=input_channels, N_classes=N_classes)
model.train()
...
writer = SummaryWriter(log_dir='/dcs05/ciprian/smart/pocus/rushil/masked_model_logs_unet')
for epoch in range(num_epochs):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), '/dcs05/ciprian/smart/pocus/rushil/masked_model_paths/unet.pth')
