...
class UNet3D_Born_etal(nn.Module):
    ...
    """    
    def __init__(self, pretrained, input_channels, N_classes, model_params_path = '/dcs05/ciprian/smart/pocus/rushil/Genesis_Chest_CT.pt'):
        ...
        if pretrained:
            ...
            # load the weights
            checkpoint = torch.load(model_params_path, map_location=torch.device('cpu'))
