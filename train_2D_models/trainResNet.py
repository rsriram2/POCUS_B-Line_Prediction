...
print("composing transforms for training")
train_transform = transforms.Compose([
    transforms.Resize((224, 224)),
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]), #this was based on standard numbers
])
print("composing transforms for val")
...
writer = SummaryWriter('runs_ver_2/ResnetProgress_{}'.format(timestamp))
epoch_number = 0
...
for epoch in range(EPOCHS):
    ...
    if avg_vloss < best_vloss:
        ...
        model_path = '/dcs05/ciprian/smart/pocus/rushil/ultraResNet50_ver_2_model.pth'
